    ...
    <form action={formAction} className={styles.form}>
      ...
      {!!child && (
        <p className={styles.intro}>
          <strong>{child.firstName}</strong> — {child.ageLabel}. კითხვები ამ ასაკზეა
          შერჩეული. უპასუხეთ დაკვირვების მიხედვით; თუ დარწმუნებული არ ხართ,
          აირჩიეთ „არ ვიცი".
        </p>
      )}
