  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24">
      ...
      {name === 'head' && (
        <>
          {/* ბავშვი */}
          <Circle cx="6.6" cy="9" r="3.2" {...common} />
          <Path d="M2.4 20.4a4.4 4.4 0 0 1 8.4 0" {...common} />
          {/* ეტაპები კიბესავით — სვეტები „ზრდის დღიურს" უკვე უჭირავს,
              კიბე კი განვითარების საფეხურებს უკეთ ამბობს */}
          <Path d="M13.4 20.4h2.6v-3h2.8v-3.4h2.8v-3.4" {...common} />
        </>
      )}
