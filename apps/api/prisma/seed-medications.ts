...
const MEDS = [
  {
    ...
    sortOrder: 1,
    concentrations: [
      { label: 'სირაფი 120 მგ / 5 მლ', mg: 120, ml: 5 },
      { label: 'სირაფი 125 მგ / 5 მლ', mg: 125, ml: 5 },
      { label: 'სირაფი 250 მგ / 5 მლ', mg: 250, ml: 5 },
  ...
  },
  {
    ...
    concentrations: [
      { label: 'სირაფი 100 მგ / 5 მლ', mg: 100, ml: 5 },
      { label: 'სირაფი 200 მგ / 5 მლ', mg: 200, ml: 5 },
  ...
  },
  {
    ...
    concentrations: [
      ...
      { label: 'სირაფი 5 მგ / 5 მლ', mg: 5, ml: 5 },
    ],
  },
];
