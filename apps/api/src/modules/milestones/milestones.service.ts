...
export class MilestonesService {
   ...
   * ასაკის კითხვები.
   *
   * მხოლოდ მონიშნული ასაკის ეტაპი — 5 თვის ბავშვს 1 თვის კითხვები
   * აღარ ეკითხება. შერჩევის წესი საერთო პაკეტშია, რომ ვებმა და
   * აპლიკაციამ ერთი და იგივე კითხვები დაინახონ.
   */
